...
//  CoreDatabase
//
//  Created by Chandrakant Shingala on 11/02/23.
//
...
class ViewController: UIViewController {
   ...
   private func insertUser() {
       ...
       studentManageObject.setValue(Double(salaryTextField.text ?? "0"), forKey: "salary")
       do {
   ...
   private func updateUsers() {
       ...
       do {
           ...
           for student in students  as! [NSManagedObject] {
               ...
               messageLabel.text = "Data Updated succesfully"
               nameTextField.text = ""
               addressTextField.text = ""
               salaryTextField.text = ""
           }
    ...
    private func deleteUsers() {
        ...
        do {
            ...
            for student in students as! [NSManagedObject] {
                ...
                messageLabel.text = "Data deleted succesfully"
                nameTextField.text = ""
                addressTextField.text = ""
                salaryTextField.text = ""
            }
